...
// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "p_usman"); // Project name
...
$CONFIG = [
	...
	"RANDOM_KEY" => '86QrJLmdMyGCS7cI', // Random key for encryption
	"ENCRYPTION_KEY" => '', // Encryption key for data protection
	"PROJECT_STYLESHEET_FILENAME" => "css/p_usman.css", // Project stylesheet file name
	...
	"PROJECT_ID" => "{4DAEC789-5DC2-4A71-96A1-2FF0758C1D39}", // Project ID (GUID)
	...
	"CONNECTION_INFO" => [
		"DB" => ["id" => "DB", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "localhost", "port" => 3307, "user" => "root", "pass" => "admin", "db" => "demo2020"],
		"demo2" => ["id" => "demo2", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "localhost", "port" => 3307, "user" => "root", "pass" => "admin", "db" => "demo2", "new" => TRUE]
	],
