...
class userlevelpermissions_list extends userlevelpermissions
{
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fuserlevelpermissionslistsrch\">" . $Language->phrase("SearchLink") . "</a>";
		$item->Visible = TRUE;
