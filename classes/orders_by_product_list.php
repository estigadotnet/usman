 ...
 * Page class
 */
class orders_by_product_list extends orders_by_product
{
	...
	// Table name
	public $TableName = 'orders_by_product';

	// Page object name
	public $PageObjName = "orders_by_product_list";

	// Grid form hidden field names
	public $FormName = "forders_by_productlist";
	...
	public function __construct()
	{
		...
		// Table object (orders_by_product)
		if (!isset($GLOBALS["orders_by_product"]) || get_class($GLOBALS["orders_by_product"]) == PROJECT_NAMESPACE . "orders_by_product") {
			$GLOBALS["orders_by_product"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["orders_by_product"];
		}
		...
		$this->AddUrl = "orders_by_productadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "orders_by_productdelete.php";
		$this->MultiUpdateUrl = "orders_by_productupdate.php";
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'orders_by_product');
		...
		$this->FilterOptions->TagClassName = "ew-filter-option forders_by_productlistsrch";
	...
	public function terminate($url = "")
	{
		...
		if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
			...
			if (class_exists($class)) {
				$doc = new $class($orders_by_product);
				$doc->Text = @$content;
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "forders_by_productlistsrch", $filters);
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"forders_by_productlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"forders_by_productlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"#\" onclick=\"return ew.submitAction(event,jQuery.extend({f:document.forders_by_productlist}," . $listaction->toJson(TRUE) . "));\">" . $icon . "</a>";
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"forders_by_productlistsrch\">" . $Language->phrase("SearchLink") . "</a>";
		$item->Visible = TRUE;
