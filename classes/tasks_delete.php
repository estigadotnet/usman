 ...
 * Page class
 */
class tasks_delete extends tasks
{
	...
	// Page object name
	public $PageObjName = "tasks_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("taskslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("taskslist.php"); // Return to list
			}
		}
	}
