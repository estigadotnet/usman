...
class userlevels_list extends userlevels
{
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fuserlevelslistsrch\">" . $Language->phrase("SearchLink") . "</a>";
		$item->Visible = TRUE;
