...
class gantt extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('gantt', 'gantt', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// name
		$this->name = new DbField('gantt', 'gantt', 'x_name', 'name', '`name`', '`name`', 200, 255, -1, FALSE, '`name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// start
		$this->start = new DbField('gantt', 'gantt', 'x_start', 'start', '`start`', CastDateFieldForLike("`start`", 0, "demo2"), 135, 19, 0, FALSE, '`start`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// end
		$this->end = new DbField('gantt', 'gantt', 'x_end', 'end', '`end`', CastDateFieldForLike("`end`", 0, "demo2"), 135, 19, 0, FALSE, '`end`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("ganttview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
