...
class cars2 extends DbTable
{
	...
	public function __construct()
	{
		...
		// ID
		$this->ID = new DbField('cars2', 'cars2', 'x_ID', 'ID', '`ID`', '`ID`', 3, 11, -1, FALSE, '`ID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// Trademark
		$this->Trademark = new DbField('cars2', 'cars2', 'x_Trademark', 'Trademark', '`Trademark`', '`Trademark`', 3, 11, -1, FALSE, '`Trademark`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Model
		$this->Model = new DbField('cars2', 'cars2', 'x_Model', 'Model', '`Model`', '`Model`', 3, 11, -1, FALSE, '`Model`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// HP
		$this->HP = new DbField('cars2', 'cars2', 'x_HP', 'HP', '`HP`', '`HP`', 2, 6, -1, FALSE, '`HP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HP->Sortable = TRUE; // Allow sort
		$this->HP->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['HP'] = &$this->HP;

		// Liter
		$this->Liter = new DbField('cars2', 'cars2', 'x_Liter', 'Liter', '`Liter`', '`Liter`', 5, 22, -1, FALSE, '`Liter`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Cyl
		$this->Cyl = new DbField('cars2', 'cars2', 'x_Cyl', 'Cyl', '`Cyl`', '`Cyl`', 16, 4, -1, FALSE, '`Cyl`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Cyl->Sortable = TRUE; // Allow sort
		$this->Cyl->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['Cyl'] = &$this->Cyl;

		// TransmissSpeedCount
		$this->TransmissSpeedCount = new DbField('cars2', 'cars2', 'x_TransmissSpeedCount', 'TransmissSpeedCount', '`TransmissSpeedCount`', '`TransmissSpeedCount`', 16, 4, -1, FALSE, '`TransmissSpeedCount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// TransmissAutomatic
		$this->TransmissAutomatic = new DbField('cars2', 'cars2', 'x_TransmissAutomatic', 'TransmissAutomatic', '`TransmissAutomatic`', '`TransmissAutomatic`', 200, 3, -1, FALSE, '`TransmissAutomatic`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TransmissAutomatic->Sortable = TRUE; // Allow sort
		$this->fields['TransmissAutomatic'] = &$this->TransmissAutomatic;

		// MPG_City
		$this->MPG_City = new DbField('cars2', 'cars2', 'x_MPG_City', 'MPG_City', '`MPG_City`', '`MPG_City`', 16, 4, -1, FALSE, '`MPG_City`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// MPG_Highway
		$this->MPG_Highway = new DbField('cars2', 'cars2', 'x_MPG_Highway', 'MPG_Highway', '`MPG_Highway`', '`MPG_Highway`', 16, 4, -1, FALSE, '`MPG_Highway`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Category
		$this->Category = new DbField('cars2', 'cars2', 'x_Category', 'Category', '`Category`', '`Category`', 200, 7, -1, FALSE, '`Category`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Category->Sortable = TRUE; // Allow sort
		$this->fields['Category'] = &$this->Category;

		// Description
		$this->Description = new DbField('cars2', 'cars2', 'x_Description', 'Description', '`Description`', '`Description`', 201, -1, -1, FALSE, '`Description`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Description->Sortable = TRUE; // Allow sort
		$this->fields['Description'] = &$this->Description;

		// Hyperlink
		$this->Hyperlink = new DbField('cars2', 'cars2', 'x_Hyperlink', 'Hyperlink', '`Hyperlink`', '`Hyperlink`', 200, 50, -1, FALSE, '`Hyperlink`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Hyperlink->Sortable = TRUE; // Allow sort
		$this->fields['Hyperlink'] = &$this->Hyperlink;

		// Price
		$this->Price = new DbField('cars2', 'cars2', 'x_Price', 'Price', '`Price`', '`Price`', 5, 22, -1, FALSE, '`Price`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Price->Sortable = TRUE; // Allow sort
		$this->Price->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['Price'] = &$this->Price;

		// Picture
		$this->Picture = new DbField('cars2', 'cars2', 'x_Picture', 'Picture', '`Picture`', '`Picture`', 205, 0, -1, TRUE, '`Picture`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->Picture->Sortable = TRUE; // Allow sort
		$this->fields['Picture'] = &$this->Picture;

		// PictureName
		$this->PictureName = new DbField('cars2', 'cars2', 'x_PictureName', 'PictureName', '`PictureName`', '`PictureName`', 200, 50, -1, FALSE, '`PictureName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PictureName->Sortable = TRUE; // Allow sort
		$this->fields['PictureName'] = &$this->PictureName;

		// PictureSize
		$this->PictureSize = new DbField('cars2', 'cars2', 'x_PictureSize', 'PictureSize', '`PictureSize`', '`PictureSize`', 3, 12, -1, FALSE, '`PictureSize`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PictureType
		$this->PictureType = new DbField('cars2', 'cars2', 'x_PictureType', 'PictureType', '`PictureType`', '`PictureType`', 200, 200, -1, FALSE, '`PictureType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PictureType->Sortable = TRUE; // Allow sort
		$this->fields['PictureType'] = &$this->PictureType;

		// PictureWidth
		$this->PictureWidth = new DbField('cars2', 'cars2', 'x_PictureWidth', 'PictureWidth', '`PictureWidth`', '`PictureWidth`', 3, 11, -1, FALSE, '`PictureWidth`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PictureHeight
		$this->PictureHeight = new DbField('cars2', 'cars2', 'x_PictureHeight', 'PictureHeight', '`PictureHeight`', '`PictureHeight`', 3, 11, -1, FALSE, '`PictureHeight`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("cars2view.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
