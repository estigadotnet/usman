...
class models extends DbTable
{
	...
	public function __construct()
	{
		...
		// ID
		$this->ID = new DbField('models', 'models', 'x_ID', 'ID', '`ID`', '`ID`', 3, 11, -1, FALSE, '`ID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// Trademark
		$this->Trademark = new DbField('models', 'models', 'x_Trademark', 'Trademark', '`Trademark`', '`Trademark`', 3, 11, -1, FALSE, '`Trademark`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Model
		$this->Model = new DbField('models', 'models', 'x_Model', 'Model', '`Model`', '`Model`', 200, 255, -1, FALSE, '`Model`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("modelsview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
