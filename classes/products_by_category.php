 ...
 */
class products_by_category extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// CategoryName
		$this->CategoryName = new DbField('products_by_category', 'products_by_category', 'x_CategoryName', 'CategoryName', '`CategoryName`', '`CategoryName`', 200, 15, -1, FALSE, '`CategoryName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CategoryName->Sortable = TRUE; // Allow sort
		$this->fields['CategoryName'] = &$this->CategoryName;

		// ProductName
		$this->ProductName = new DbField('products_by_category', 'products_by_category', 'x_ProductName', 'ProductName', '`ProductName`', '`ProductName`', 200, 40, -1, FALSE, '`ProductName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ProductName->Sortable = TRUE; // Allow sort
		$this->fields['ProductName'] = &$this->ProductName;

		// QuantityPerUnit
		$this->QuantityPerUnit = new DbField('products_by_category', 'products_by_category', 'x_QuantityPerUnit', 'QuantityPerUnit', '`QuantityPerUnit`', '`QuantityPerUnit`', 200, 20, -1, FALSE, '`QuantityPerUnit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->QuantityPerUnit->Sortable = TRUE; // Allow sort
		$this->fields['QuantityPerUnit'] = &$this->QuantityPerUnit;

		// UnitsInStock
		$this->UnitsInStock = new DbField('products_by_category', 'products_by_category', 'x_UnitsInStock', 'UnitsInStock', '`UnitsInStock`', '`UnitsInStock`', 2, 6, -1, FALSE, '`UnitsInStock`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Discontinued
		$this->Discontinued = new DbField('products_by_category', 'products_by_category', 'x_Discontinued', 'Discontinued', '`Discontinued`', '`Discontinued`', 202, 1, -1, FALSE, '`Discontinued`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "products_by_categorylist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "products_by_categoryview.php")
			return $Language->phrase("View");
		elseif ($pageName == "products_by_categoryedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "products_by_categoryadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("products_by_categoryview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("products_by_categoryview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "products_by_categoryadd.php?" . $this->getUrlParm($parm);
		else
			$url = "products_by_categoryadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("products_by_categoryedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("products_by_categoryadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("products_by_categorydelete.php", $this->getUrlParm());
	}
