...
class order_details_extended extends DbTable
{
	...
	public function __construct()
	{
		...
		// CompanyName
		$this->CompanyName = new DbField('order_details_extended', 'order details extended', 'x_CompanyName', 'CompanyName', '`CompanyName`', '`CompanyName`', 200, 40, -1, FALSE, '`CompanyName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CompanyName->Sortable = TRUE; // Allow sort
		$this->fields['CompanyName'] = &$this->CompanyName;

		// OrderID
		$this->OrderID = new DbField('order_details_extended', 'order details extended', 'x_OrderID', 'OrderID', '`OrderID`', '`OrderID`', 3, 11, -1, FALSE, '`OrderID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// ProductName
		$this->ProductName = new DbField('order_details_extended', 'order details extended', 'x_ProductName', 'ProductName', '`ProductName`', '`ProductName`', 200, 40, -1, FALSE, '`ProductName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ProductName->Sortable = TRUE; // Allow sort
		$this->fields['ProductName'] = &$this->ProductName;

		// UnitPrice
		$this->UnitPrice = new DbField('order_details_extended', 'order details extended', 'x_UnitPrice', 'UnitPrice', '`UnitPrice`', '`UnitPrice`', 5, 22, -1, FALSE, '`UnitPrice`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Quantity
		$this->Quantity = new DbField('order_details_extended', 'order details extended', 'x_Quantity', 'Quantity', '`Quantity`', '`Quantity`', 2, 6, -1, FALSE, '`Quantity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Quantity->Sortable = TRUE; // Allow sort
		$this->Quantity->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['Quantity'] = &$this->Quantity;

		// Discount
		$this->Discount = new DbField('order_details_extended', 'order details extended', 'x_Discount', 'Discount', '`Discount`', '`Discount`', 5, 22, -1, FALSE, '`Discount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Extended Price
		$this->Extended_Price = new DbField('order_details_extended', 'order details extended', 'x_Extended_Price', 'Extended Price', '`Extended Price`', '`Extended Price`', 5, 23, -1, FALSE, '`Extended Price`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("order_details_extendedview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
