 ...
 * Page class
 */
class employee_sales_by_county_for_1997_list extends employee_sales_by_county_for_1997
{
	...
	// Table name
	public $TableName = 'employee_sales_by_county_for_1997';

	// Page object name
	public $PageObjName = "employee_sales_by_county_for_1997_list";

	// Grid form hidden field names
	public $FormName = "femployee_sales_by_county_for_1997list";
	...
	public function __construct()
	{
		...
		// Table object (employee_sales_by_county_for_1997)
		if (!isset($GLOBALS["employee_sales_by_county_for_1997"]) || get_class($GLOBALS["employee_sales_by_county_for_1997"]) == PROJECT_NAMESPACE . "employee_sales_by_county_for_1997") {
			$GLOBALS["employee_sales_by_county_for_1997"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["employee_sales_by_county_for_1997"];
		}
		...
		$this->AddUrl = "employee_sales_by_county_for_1997add.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "employee_sales_by_county_for_1997delete.php";
		$this->MultiUpdateUrl = "employee_sales_by_county_for_1997update.php";
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'employee_sales_by_county_for_1997');
		...
		$this->FilterOptions->TagClassName = "ew-filter-option femployee_sales_by_county_for_1997listsrch";
	...
	public function terminate($url = "")
	{
		...
		// Export
		global $employee_sales_by_county_for_1997;
		if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
			...
			if (class_exists($class)) {
				$doc = new $class($employee_sales_by_county_for_1997);
				$doc->Text = @$content;
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "femployee_sales_by_county_for_1997listsrch", $filters);
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"femployee_sales_by_county_for_1997listsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"femployee_sales_by_county_for_1997listsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"#\" onclick=\"return ew.submitAction(event,jQuery.extend({f:document.femployee_sales_by_county_for_1997list}," . $listaction->toJson(TRUE) . "));\">" . $icon . "</a>";
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"femployee_sales_by_county_for_1997listsrch\">" . $Language->phrase("SearchLink") . "</a>";
		$item->Visible = TRUE;
