...
class dji extends DbTable
{
	...
	public function __construct()
	{
		...
		// ID
		$this->ID = new DbField('dji', 'dji', 'x_ID', 'ID', '`ID`', '`ID`', 3, 11, -1, FALSE, '`ID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// Date
		$this->Date = new DbField('dji', 'dji', 'x_Date', 'Date', '`Date`', CastDateFieldForLike("`Date`", 0, "demo2"), 135, 19, 0, FALSE, '`Date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Open
		$this->Open = new DbField('dji', 'dji', 'x_Open', 'Open', '`Open`', '`Open`', 5, 22, -1, FALSE, '`Open`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Open->Sortable = TRUE; // Allow sort
		$this->Open->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['Open'] = &$this->Open;

		// High
		$this->High = new DbField('dji', 'dji', 'x_High', 'High', '`High`', '`High`', 5, 22, -1, FALSE, '`High`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->High->Sortable = TRUE; // Allow sort
		$this->High->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['High'] = &$this->High;

		// Low
		$this->Low = new DbField('dji', 'dji', 'x_Low', 'Low', '`Low`', '`Low`', 5, 22, -1, FALSE, '`Low`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Low->Sortable = TRUE; // Allow sort
		$this->Low->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['Low'] = &$this->Low;

		// Close
		$this->Close = new DbField('dji', 'dji', 'x_Close', 'Close', '`Close`', '`Close`', 5, 22, -1, FALSE, '`Close`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Volume
		$this->Volume = new DbField('dji', 'dji', 'x_Volume', 'Volume', '`Volume`', '`Volume`', 5, 22, -1, FALSE, '`Volume`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Adj Close
		$this->Adj_Close = new DbField('dji', 'dji', 'x_Adj_Close', 'Adj Close', '`Adj Close`', '`Adj Close`', 5, 22, -1, FALSE, '`Adj Close`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Name
		$this->Name = new DbField('dji', 'dji', 'x_Name', 'Name', '`Name`', CastDateFieldForLike("`Name`", 0, "demo2"), 135, 19, 0, FALSE, '`Name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Name->Sortable = TRUE; // Allow sort
		$this->Name->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['Name'] = &$this->Name;

		// Name2
		$this->Name2 = new DbField('dji', 'dji', 'x_Name2', 'Name2', '`Name2`', '`Name2`', 200, 50, -1, FALSE, '`Name2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("djiview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
