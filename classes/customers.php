...
class customers extends DbTable
{
	...
	public function __construct()
	{
		...
		// CustomerID
		$this->CustomerID = new DbField('customers', 'customers', 'x_CustomerID', 'CustomerID', '`CustomerID`', '`CustomerID`', 200, 5, -1, FALSE, '`CustomerID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CompanyName
		$this->CompanyName = new DbField('customers', 'customers', 'x_CompanyName', 'CompanyName', '`CompanyName`', '`CompanyName`', 200, 40, -1, FALSE, '`CompanyName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CompanyName->Sortable = TRUE; // Allow sort
		$this->fields['CompanyName'] = &$this->CompanyName;

		// ContactName
		$this->ContactName = new DbField('customers', 'customers', 'x_ContactName', 'ContactName', '`ContactName`', '`ContactName`', 200, 30, -1, FALSE, '`ContactName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ContactName->Sortable = TRUE; // Allow sort
		$this->fields['ContactName'] = &$this->ContactName;

		// ContactTitle
		$this->ContactTitle = new DbField('customers', 'customers', 'x_ContactTitle', 'ContactTitle', '`ContactTitle`', '`ContactTitle`', 200, 30, -1, FALSE, '`ContactTitle`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ContactTitle->Sortable = TRUE; // Allow sort
		$this->fields['ContactTitle'] = &$this->ContactTitle;

		// Address
		$this->Address = new DbField('customers', 'customers', 'x_Address', 'Address', '`Address`', '`Address`', 200, 60, -1, FALSE, '`Address`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Address->Sortable = TRUE; // Allow sort
		$this->fields['Address'] = &$this->Address;

		// City
		$this->City = new DbField('customers', 'customers', 'x_City', 'City', '`City`', '`City`', 200, 15, -1, FALSE, '`City`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->City->Sortable = TRUE; // Allow sort
		$this->fields['City'] = &$this->City;

		// Region
		$this->Region = new DbField('customers', 'customers', 'x_Region', 'Region', '`Region`', '`Region`', 200, 15, -1, FALSE, '`Region`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Region->Sortable = TRUE; // Allow sort
		$this->fields['Region'] = &$this->Region;

		// PostalCode
		$this->PostalCode = new DbField('customers', 'customers', 'x_PostalCode', 'PostalCode', '`PostalCode`', '`PostalCode`', 200, 10, -1, FALSE, '`PostalCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PostalCode->Sortable = TRUE; // Allow sort
		$this->fields['PostalCode'] = &$this->PostalCode;

		// Country
		$this->Country = new DbField('customers', 'customers', 'x_Country', 'Country', '`Country`', '`Country`', 200, 15, -1, FALSE, '`Country`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Country->Sortable = TRUE; // Allow sort
		$this->fields['Country'] = &$this->Country;

		// Phone
		$this->Phone = new DbField('customers', 'customers', 'x_Phone', 'Phone', '`Phone`', '`Phone`', 200, 24, -1, FALSE, '`Phone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Phone->Sortable = TRUE; // Allow sort
		$this->fields['Phone'] = &$this->Phone;

		// Fax
		$this->Fax = new DbField('customers', 'customers', 'x_Fax', 'Fax', '`Fax`', '`Fax`', 200, 24, -1, FALSE, '`Fax`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
