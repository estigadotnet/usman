...
class shippers extends DbTable
{
	...
	public function __construct()
	{
		...
		// CompanyName
		$this->CompanyName = new DbField('shippers', 'shippers', 'x_CompanyName', 'CompanyName', '`CompanyName`', '`CompanyName`', 200, 40, -1, FALSE, '`CompanyName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CompanyName->Sortable = TRUE; // Allow sort
		$this->fields['CompanyName'] = &$this->CompanyName;

		// Phone
		$this->Phone = new DbField('shippers', 'shippers', 'x_Phone', 'Phone', '`Phone`', '`Phone`', 200, 24, -1, FALSE, '`Phone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("shippersview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
