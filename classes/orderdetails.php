...
class orderdetails extends DbTable
{
	...
	public function __construct()
	{
		...
		// OrderID
		$this->OrderID = new DbField('orderdetails', 'orderdetails', 'x_OrderID', 'OrderID', '`OrderID`', '`OrderID`', 3, 11, -1, FALSE, '`OrderID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ProductID
		$this->ProductID = new DbField('orderdetails', 'orderdetails', 'x_ProductID', 'ProductID', '`ProductID`', '`ProductID`', 3, 11, -1, FALSE, '`ProductID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// UnitPrice
		$this->UnitPrice = new DbField('orderdetails', 'orderdetails', 'x_UnitPrice', 'UnitPrice', '`UnitPrice`', '`UnitPrice`', 5, 22, -1, FALSE, '`UnitPrice`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Quantity
		$this->Quantity = new DbField('orderdetails', 'orderdetails', 'x_Quantity', 'Quantity', '`Quantity`', '`Quantity`', 2, 6, -1, FALSE, '`Quantity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Quantity->Sortable = TRUE; // Allow sort
		$this->Quantity->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['Quantity'] = &$this->Quantity;

		// Discount
		$this->Discount = new DbField('orderdetails', 'orderdetails', 'x_Discount', 'Discount', '`Discount`', '`Discount`', 5, 22, -1, FALSE, '`Discount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("orderdetailsview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
