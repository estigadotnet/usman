...
class categories extends DbTable
{
	...
	public function __construct()
	{
		...
		// CategoryName
		$this->CategoryName = new DbField('categories', 'categories', 'x_CategoryName', 'CategoryName', '`CategoryName`', '`CategoryName`', 200, 15, -1, FALSE, '`CategoryName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CategoryName->Sortable = TRUE; // Allow sort
		$this->fields['CategoryName'] = &$this->CategoryName;

		// Description
		$this->Description = new DbField('categories', 'categories', 'x_Description', 'Description', '`Description`', '`Description`', 201, -1, -1, FALSE, '`Description`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Description->Sortable = TRUE; // Allow sort
		$this->fields['Description'] = &$this->Description;

		// Picture
		$this->Picture = new DbField('categories', 'categories', 'x_Picture', 'Picture', '`Picture`', '`Picture`', 205, 0, -1, TRUE, '`Picture`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("categoriesview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
