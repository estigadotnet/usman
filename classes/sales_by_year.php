 ...
 */
class sales_by_year extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// ShippedDate
		$this->ShippedDate = new DbField('sales_by_year', 'sales_by_year', 'x_ShippedDate', 'ShippedDate', '`ShippedDate`', CastDateFieldForLike("`ShippedDate`", 0, "DB"), 135, 19, 0, FALSE, '`ShippedDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// OrderID
		$this->OrderID = new DbField('sales_by_year', 'sales_by_year', 'x_OrderID', 'OrderID', '`OrderID`', '`OrderID`', 3, 11, -1, FALSE, '`OrderID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Subtotal
		$this->Subtotal = new DbField('sales_by_year', 'sales_by_year', 'x_Subtotal', 'Subtotal', '`Subtotal`', '`Subtotal`', 5, 23, -1, FALSE, '`Subtotal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Year
		$this->Year = new DbField('sales_by_year', 'sales_by_year', 'x_Year', 'Year', '`Year`', '`Year`', 3, 4, -1, FALSE, '`Year`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		global $Language;
		if ($pageName == "sales_by_yearview.php")
			return $Language->phrase("View");
		elseif ($pageName == "sales_by_yearedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "sales_by_yearadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("sales_by_yearview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("sales_by_yearview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "sales_by_yearadd.php?" . $this->getUrlParm($parm);
		else
			$url = "sales_by_yearadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("sales_by_yearedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("sales_by_yearadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("sales_by_yeardelete.php", $this->getUrlParm());
	}
