...
class orders2 extends DbTable
{
	...
	public function __construct()
	{
		...
		// OrderID
		$this->OrderID = new DbField('orders2', 'orders2', 'x_OrderID', 'OrderID', '`OrderID`', '`OrderID`', 3, 11, -1, FALSE, '`OrderID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// CustomerID
		$this->CustomerID = new DbField('orders2', 'orders2', 'x_CustomerID', 'CustomerID', '`CustomerID`', '`CustomerID`', 200, 5, -1, FALSE, '`CustomerID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CustomerID->Sortable = TRUE; // Allow sort
		$this->fields['CustomerID'] = &$this->CustomerID;

		// EmployeeID
		$this->EmployeeID = new DbField('orders2', 'orders2', 'x_EmployeeID', 'EmployeeID', '`EmployeeID`', '`EmployeeID`', 3, 11, -1, FALSE, '`EmployeeID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EmployeeID->Sortable = TRUE; // Allow sort
		$this->EmployeeID->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['EmployeeID'] = &$this->EmployeeID;

		// OrderDate
		$this->OrderDate = new DbField('orders2', 'orders2', 'x_OrderDate', 'OrderDate', '`OrderDate`', CastDateFieldForLike("`OrderDate`", 0, "DB"), 135, 19, 0, FALSE, '`OrderDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// RequiredDate
		$this->RequiredDate = new DbField('orders2', 'orders2', 'x_RequiredDate', 'RequiredDate', '`RequiredDate`', CastDateFieldForLike("`RequiredDate`", 0, "DB"), 135, 19, 0, FALSE, '`RequiredDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ShippedDate
		$this->ShippedDate = new DbField('orders2', 'orders2', 'x_ShippedDate', 'ShippedDate', '`ShippedDate`', CastDateFieldForLike("`ShippedDate`", 0, "DB"), 135, 19, 0, FALSE, '`ShippedDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ShipVia
		$this->ShipVia = new DbField('orders2', 'orders2', 'x_ShipVia', 'ShipVia', '`ShipVia`', '`ShipVia`', 3, 11, -1, FALSE, '`ShipVia`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Freight
		$this->Freight = new DbField('orders2', 'orders2', 'x_Freight', 'Freight', '`Freight`', '`Freight`', 5, 22, -1, FALSE, '`Freight`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ShipName
		$this->ShipName = new DbField('orders2', 'orders2', 'x_ShipName', 'ShipName', '`ShipName`', '`ShipName`', 200, 40, -1, FALSE, '`ShipName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ShipName->Sortable = TRUE; // Allow sort
		$this->fields['ShipName'] = &$this->ShipName;

		// ShipAddress
		$this->ShipAddress = new DbField('orders2', 'orders2', 'x_ShipAddress', 'ShipAddress', '`ShipAddress`', '`ShipAddress`', 200, 60, -1, FALSE, '`ShipAddress`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ShipAddress->Sortable = TRUE; // Allow sort
		$this->fields['ShipAddress'] = &$this->ShipAddress;

		// ShipCity
		$this->ShipCity = new DbField('orders2', 'orders2', 'x_ShipCity', 'ShipCity', '`ShipCity`', '`ShipCity`', 200, 15, -1, FALSE, '`ShipCity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ShipCity->Sortable = TRUE; // Allow sort
		$this->fields['ShipCity'] = &$this->ShipCity;

		// ShipRegion
		$this->ShipRegion = new DbField('orders2', 'orders2', 'x_ShipRegion', 'ShipRegion', '`ShipRegion`', '`ShipRegion`', 200, 15, -1, FALSE, '`ShipRegion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ShipRegion->Sortable = TRUE; // Allow sort
		$this->fields['ShipRegion'] = &$this->ShipRegion;

		// ShipPostalCode
		$this->ShipPostalCode = new DbField('orders2', 'orders2', 'x_ShipPostalCode', 'ShipPostalCode', '`ShipPostalCode`', '`ShipPostalCode`', 200, 10, -1, FALSE, '`ShipPostalCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ShipPostalCode->Sortable = TRUE; // Allow sort
		$this->fields['ShipPostalCode'] = &$this->ShipPostalCode;

		// ShipCountry
		$this->ShipCountry = new DbField('orders2', 'orders2', 'x_ShipCountry', 'ShipCountry', '`ShipCountry`', '`ShipCountry`', 200, 15, -1, FALSE, '`ShipCountry`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("orders2view.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
