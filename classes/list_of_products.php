 ...
 */
class list_of_products extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// ProductName
		$this->ProductName = new DbField('list_of_products', 'list_of_products', 'x_ProductName', 'ProductName', '`ProductName`', '`ProductName`', 200, 40, -1, FALSE, '`ProductName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ProductName->Sortable = TRUE; // Allow sort
		$this->fields['ProductName'] = &$this->ProductName;

		// CategoryName
		$this->CategoryName = new DbField('list_of_products', 'list_of_products', 'x_CategoryName', 'CategoryName', '`CategoryName`', '`CategoryName`', 200, 15, -1, FALSE, '`CategoryName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CategoryName->Sortable = TRUE; // Allow sort
		$this->fields['CategoryName'] = &$this->CategoryName;

		// QuantityPerUnit
		$this->QuantityPerUnit = new DbField('list_of_products', 'list_of_products', 'x_QuantityPerUnit', 'QuantityPerUnit', '`QuantityPerUnit`', '`QuantityPerUnit`', 200, 20, -1, FALSE, '`QuantityPerUnit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->QuantityPerUnit->Sortable = TRUE; // Allow sort
		$this->fields['QuantityPerUnit'] = &$this->QuantityPerUnit;

		// UnitsInStock
		$this->UnitsInStock = new DbField('list_of_products', 'list_of_products', 'x_UnitsInStock', 'UnitsInStock', '`UnitsInStock`', '`UnitsInStock`', 2, 6, -1, FALSE, '`UnitsInStock`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ProductName2
		$this->ProductName2 = new DbField('list_of_products', 'list_of_products', 'x_ProductName2', 'ProductName2', '`ProductName2`', '`ProductName2`', 200, 40, -1, FALSE, '`ProductName2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ProductName2->Sortable = TRUE; // Allow sort
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "list_of_productslist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "list_of_productsview.php")
			return $Language->phrase("View");
		elseif ($pageName == "list_of_productsedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "list_of_productsadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("list_of_productsview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("list_of_productsview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "list_of_productsadd.php?" . $this->getUrlParm($parm);
		else
			$url = "list_of_productsadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("list_of_productsedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("list_of_productsadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("list_of_productsdelete.php", $this->getUrlParm());
	}
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->ProductName2->setDbValue($rs->fields('ProductName2'));
	}
	...
	public function renderEditRow()
	{
		...
		// ProductName2
		$this->ProductName2->EditAttrs["class"] = "form-control";
		$this->ProductName2->EditCustomAttributes = "";
