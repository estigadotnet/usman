...
class categories_list extends categories
{
	...
	protected function setupKeyValues($key)
	{
		...
		if (count($arKeyFlds) >= 1) {
			$this->CategoryID->setOldValue($arKeyFlds[0]);
			if (!is_numeric($this->CategoryID->OldValue))
				return FALSE;
		}
		return TRUE;
	}
	...
	protected function loadOldRecord()
	{
		...
		if (strval($this->getKey("CategoryID")) != "")
			$this->CategoryID->OldValue = $this->getKey("CategoryID"); // CategoryID
		else
			$validKey = FALSE;
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fcategorieslistsrch\">" . $Language->phrase("SearchLink") . "</a>";
		$item->Visible = TRUE;
