 ...
 * Page class
 */
class sales_by_year_list extends sales_by_year
{
	...
	// Table name
	public $TableName = 'sales_by_year';

	// Page object name
	public $PageObjName = "sales_by_year_list";

	// Grid form hidden field names
	public $FormName = "fsales_by_yearlist";
	...
	public function __construct()
	{
		...
		if (!isset($GLOBALS["sales_by_year"]) || get_class($GLOBALS["sales_by_year"]) == PROJECT_NAMESPACE . "sales_by_year") {
			...
			$GLOBALS["Table"] = &$GLOBALS["sales_by_year"];
		}
		...
		$this->AddUrl = "sales_by_yearadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "sales_by_yeardelete.php";
		$this->MultiUpdateUrl = "sales_by_yearupdate.php";
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'sales_by_year');
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fsales_by_yearlistsrch";
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fsales_by_yearlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = FALSE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fsales_by_yearlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = FALSE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"#\" onclick=\"return ew.submitAction(event,jQuery.extend({f:document.fsales_by_yearlist}," . $listaction->toJson(TRUE) . "));\">" . $icon . "</a>";
